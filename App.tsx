  ...
  const startGeneration = () => {
    ...
    const interval = setInterval(() => {
      ...
      if (p >= 100) {
        ...
        // Here we just use a placeholder to unlock the "Download" state
        setGeneratedVideoUrl("mock_url");
      }
    }, 50);
  };
               ...
               {isGenerating ? (
                  ...
                  <div className="text-center animate-fade-in">
                    ...
                    <div className="flex gap-4 justify-center">
                      ...
                      <Button onClick={() => alert("Simulated Download Started!")} variant="success">
                        <i className="fas fa-download"></i> Download MP4
                      </Button>
                    </div>
                  </div>
               )}
